        ...
        <div className="hero-inner">
          <div className="hero-content">
            ...
            <div className="hero-buttons">
              ...
              <a href="https://wa.me/6287846725184" target="_blank" rel="noopener noreferrer" className="btn-primary" style={{ background: '#0f5132', borderRadius: '9999px', padding: '12px 28px', display: 'inline-flex', alignItems: 'center', gap: '8px' }}>
